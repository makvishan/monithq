...
export const SECURITY_RECOMMENDATIONS = {
  ...
  WEAK_CSP: {
    ...
    recommendation:
      "Tighten CSP policy by removing unsafe-inline and unsafe-eval",
  ...
  NO_X_XSS_PROTECTION: {
    ...
    recommendation:
      "Add X-XSS-Protection header (or use CSP for modern browsers)",
...
export function determineSiteStatus(statusCode, responseTime) {
  if (
    ...
    statusCode <= HTTP_STATUS.SUCCESS_MAX
  ) {
...
export const FOOTER_LINKS = {
  Product: [
    { label: "Features", href: "/#features" },
    { label: "Pricing", href: "/#pricing" },
    { label: "Docs", href: "/static/docs" },
  ],
  Company: [
    { label: "About", href: "/static/about" },
    { label: "Blog", href: "/static/blog" },
  ],
  Legal: [
