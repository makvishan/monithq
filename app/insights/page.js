...
export default function InsightsPage() {
  const handleGenerateReport = () => {
    showToast.info('Generating new AI report... (This is a demo)');
  };
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <MainContent>
            ...
            <Card className="glow-primary">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-4xl font-bold gradient-text">{DUMMY_AI_INSIGHTS.length}</p>
              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-4xl font-bold gradient-text">
                    {(DUMMY_AI_INSIGHTS.reduce((acc, i) => acc + i.confidence, 0) / DUMMY_AI_INSIGHTS.length * 100).toFixed(0)}%
                  </p>
              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-4xl font-bold text-foreground">
                    {DUMMY_AI_INSIGHTS.filter(i => i.type === 'recommendation').length}
                  </p>
        ...
        <div className="space-y-6">
          {DUMMY_AI_INSIGHTS.map((insight, index) => {
            ...
            const styles = typeStyles[insight.type] || typeStyles.performance;
                  ...
                  <CardHeader>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <CardDescription>{formatRelativeTime(insight.timestamp)}</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
